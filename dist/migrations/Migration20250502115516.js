...
exports.Migration20250502115516 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20250502115516 extends migrations_1.Migration {
    async up() {
        ...
        this.addSql('create table "category" ("id" uuid not null, "name" varchar(255) not null, "parent_category_id" varchar(255) null, "parentCategoryId" uuid null, constraint "category_pkey" primary key ("id"));');
        ...
        this.addSql('create table "product" ("id" uuid not null, "name" varchar(255) not null, "slug" varchar(255) not null, "description" varchar(255) not null, "price" numeric(10,0) not null, "material" varchar(255) not null, "weight" int null, "category_id" uuid not null, "subcategory_id" uuid not null, "company_id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "product_pkey" primary key ("id"));');
        ...
        this.addSql('create table "review" ("id" uuid not null, "user_id" uuid not null, "product_id" uuid not null, "comment" text not null, "rating" int not null, "created_at" timestamptz not null, constraint "review_pkey" primary key ("id"));');
...
exports.Migration20250502115516 = Migration20250502115516;
//# sourceMappingURL=Migration20250502115516.js.map