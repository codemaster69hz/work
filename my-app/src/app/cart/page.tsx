        ...
        {!cart || cart.items.length === 0 ? (
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="px-4 py-5 sm:px-6 border-t border-gray-200">
              ...
              {checkoutError && (
                <div className="text-red-600 text-sm mt-2">{checkoutError}</div>
              )}

              <div className="flex justify-end mt-6">
                <button
                  onClick={handleCheckout}
                  className={`bg-indigo-600 border border-transparent rounded-md py-3 px-4 flex text-base font-medium text-white hover:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-offset-2 ${isCheckingOut ? 'opacity-75 cursor-not-allowed' : ''}`}
